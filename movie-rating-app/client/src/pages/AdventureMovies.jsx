      ...
      <div className="max-w-[1720px] mx-auto px-8">
        <div className="mb-12">
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <h1 className="text-4xl md:text-5xl font-display font-black text-white uppercase tracking-tighter">Adventure Archives</h1>
          </div>
          <p className="text-gray-500 font-mono text-[10px] uppercase tracking-[0.3em]">Exploring the outer rim of cinematic data</p>
        </div>
        ...
        {filteredMovies.length > 0 ? (
          ...
          <div className="text-center py-40">
            <div className="glass-panel inline-block p-12 rounded-[3rem]">
              <h2 className="text-3xl font-display font-black text-white mb-4">ADVENTURE DATA DECRYPTED</h2>
              <p className="text-gray-500 font-mono tracking-widest">SEARCHING FOR NEW EXPEDITIONS...</p>
            </div>
          </div>
        )}
      </div>
