...
const Footer = () => {
  return (
    <footer className="bg-dark/50 backdrop-blur-md pt-16 pb-8 border-t border-white/5 relative overflow-hidden">
      {/* Background Glow */}
      <div className="absolute -bottom-24 -left-24 w-96 h-96 bg-primary/5 rounded-full blur-[100px]"></div>
      <div className="absolute top-0 right-0 w-64 h-64 bg-primary-magenta/5 rounded-full blur-[80px]"></div>

      <div className="max-w-[1440px] mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-1">
            <Link to="/" className="text-3xl font-display font-black tracking-tighter neon-text-cyan italic mb-6 block">
              CINEMORA
            </Link>
          ...
          <div>
            <h4 className="text-white font-bold text-xs uppercase tracking-[0.2em] mb-6">Explore</h4>
            <ul className="space-y-4 text-gray-500 text-sm">
              ...
              <li><a href="#" className="hover:text-primary transition-colors">My Watchlist</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-gray-600 text-xs tracking-wider">
            © 2025 CINEMORA. ALL RIGHTS RESERVED.
          </p>
